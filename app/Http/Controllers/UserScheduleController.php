...
class UserScheduleController extends Controller
{
    ...
    public function index()
    {
        ...
        if(!is_null($selected_package)) { //to handle exception
            ...
            return view('customer_pages.schedule_blocked', compact('schedule_monday', 'schedule_tuesday', 'schedule_wednesday', 'schedule_thursday', 'schedule_friday', 'schedule_saturday', 'schedule_sunday', 'Checkbox'));
        }
    }//index
